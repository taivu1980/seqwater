...
//  $vars['page']['content']['system_main']['block_regions']["#value"]['footer'] = "Footer";
//  var_dump($vars['page']['content']['system_main']['block_regions']);die;
...
function admintheme_css_alter(&$css) {
  ...
  if (isset($css['misc/vertical-tabs.css'])) {
    $css['misc/vertical-tabs.css']['data'] = drupal_get_path('theme', 'admintheme') . '/vertical-tabs.css';
    $css['misc/vertical-tabs.css']['type'] = 'file';
  }
  if (isset($css['misc/vertical-tabs-rtl.css'])) {
    $css['misc/vertical-tabs-rtl.css']['data'] = drupal_get_path('theme', 'admintheme') . '/vertical-tabs-rtl.css';
