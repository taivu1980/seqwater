...
(function($) {
    var NivoSlider = function(element, options){
        ...
        var processCaption = function(settings){
            ...
            var strCaption = '<div id="pitch"><ul>';
            var countCaption = 0;
            ...
            $('.nivo-caption-customize').removeClass('active');
            $('.nivo-caption-customize:eq('+ vars.currentSlide +')').addClass('active');
        ...
        //Create caption
        slider.append(processCaption);
        $('.nivo-caption-customize').click(function(){
